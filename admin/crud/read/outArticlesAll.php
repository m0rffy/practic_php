<?php
    ...
    function outArticlesAll() {
        ...
        // выполнение запроса
        $result = $mysqli->query("SELECT * FROM `articles` WHERE `page` = 'articles'");
        ...
        foreach ($rows as $item) {
            ...
            if ($item["image"] != null) 
                $image = '/images/articles/' . $item["image"];
            else
                ...
                <article>
                    <div class="article">
                        ...
                        <div class="article__float_left">
                            ...
                            <p class="article__text">' . $item["teaser"] . ' <a href="/articles/?id=' . $item["id"] . '" class="article__link_text">[Подробнее...]</a></p>
