...
<head>
    ...
    <title>Испанская живопись</title>
...
<body>
    ...
    <header class="header">
        ...
        <div class="header__intro">
            <h1 class="header__title">Испанская живопись</h1>
        </div>
    </header>
    ...
    <main class="main container">
        <?php
            ...
            foreach ($arr as $item) {
                // если страна текущего художника == Испания, то выводим данные массива
                if ($item["content"]["country"] == "Испания") {
                    $museums = "";
