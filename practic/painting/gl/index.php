...
<head>
    ...
    <title>Голландская живопись</title>
...
<body>
    ...
    <header class="header">
        ...
        <div class="header__intro">
            <h1 class="header__title">Голландская живопись</h1>
        </div>
    </header>
    ...
    <main class="main container">
        <?php
            ...
            foreach ($arr as $item) {
                // если страна текущего художника == Голландия, то выводим данные массива
                if ($item["content"]["country"] == "Голландия") {
                    $museums = "";
